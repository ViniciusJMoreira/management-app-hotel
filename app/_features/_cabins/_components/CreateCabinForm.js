...
import { createCabin } from "@/app/_features/_cabins/actions";
...
function CreateCabinForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          <div className="mt-6">
            ...
            <p className="mt-1 text-sm/6 text-gray-600 dark:text-gray-400 max-w-3xl">
              Create a new cabin by defining its type, amenities, and main
              characteristics. This information will be used to manage and
              display the cabin correctly.
            </p>
          </div>
        </div>
      ...
      <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-end gap-x-4 gap-y-3">
